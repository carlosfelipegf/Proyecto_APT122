...
class Perfil(models.Model):
    ...
    certificaciones = models.TextField(blank=True, null=True, verbose_name="Certificaciones / Experiencia")
    ...
    # --- CAMPO NUEVO DE SEGURIDAD ---
    cambio_clave_inicial_completado = models.BooleanField(
        default=False, 
        verbose_name="Cambio de clave inicial completado"
    )
