# Generated by Django 5.2.7 on 2025-10-15 16:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('ASIGNADA', 'Asignada a Técnico'), ('EN_PROGRESO', 'En Progreso (Borrador Guardado)'), ('TERMINADA', 'Inspección Terminada')], default='ASIGNADA', max_length=50, verbose_name='Estado de la Inspección')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plantilla_tarea', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='usuarios.plantillatarea', verbose_name='Tarea Base')),
            ],
        ),
    ]
